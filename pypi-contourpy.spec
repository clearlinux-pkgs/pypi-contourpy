...
Source0  : https://files.pythonhosted.org/packages/66/54/eb9bfc647b19f2009dd5c7f5ec51c4e6ca831725f1aea7a993034f483147/contourpy-1.3.2.tar.gz
...
%prep
%setup -q -n contourpy-1.3.2
cd %{_builddir}/contourpy-1.3.2
pushd ..
cp -a contourpy-1.3.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744748128
