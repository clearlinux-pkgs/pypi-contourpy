...
Source0  : https://files.pythonhosted.org/packages/25/c2/fc7193cc5383637ff390a712e88e4ded0452c9fbcf84abe3de5ea3df1866/contourpy-1.3.1.tar.gz
...
%prep
%setup -q -n contourpy-1.3.1
cd %{_builddir}/contourpy-1.3.1
pushd ..
cp -a contourpy-1.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731431258
