...
Source0  : https://files.pythonhosted.org/packages/8d/9e/e4786569b319847ffd98a8326802d5cf8a5500860dbfc2df1f0f4883ed99/contourpy-1.2.1.tar.gz
...
%prep
%setup -q -n contourpy-1.2.1
cd %{_builddir}/contourpy-1.2.1
pushd ..
cp -a contourpy-1.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712109586
