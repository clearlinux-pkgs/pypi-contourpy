...
Source0  : https://files.pythonhosted.org/packages/11/a3/48ddc7ae832b000952cf4be64452381d150a41a2299c2eb19237168528d1/contourpy-1.2.0.tar.gz
...
%prep
%setup -q -n contourpy-1.2.0
cd %{_builddir}/contourpy-1.2.0
pushd ..
cp -a contourpy-1.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699284611
